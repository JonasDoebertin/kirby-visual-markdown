 ...
 * @since 1.3.0
 */
__WEBPACK_IMPORTED_MODULE_0_codemirror___default.a.defineMode('kirbytext', function (config, modeConfig) {
    'use strict';
    ...
    return __WEBPACK_IMPORTED_MODULE_0_codemirror___default.a.overlayMode(__WEBPACK_IMPORTED_MODULE_0_codemirror___default.a.getMode(config, modeConfig), __WEBPACK_IMPORTED_MODULE_0_codemirror___default.a.simpleMode(config, states));
});
